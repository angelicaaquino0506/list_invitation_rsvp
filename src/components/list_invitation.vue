...
const eighteenRosesData = ref<{ name: string; value: string }[]>([
  ...
  { name: 'Mr. River Palomeno', value: 'River Palomeno' },
  ...
  { name: 'Mr. Alwyn Dave Almazar', value: 'Alwyn Dave Almazar' },
...
const eighteenCandelData = ref<{ name: string; value: string }[]>([
  ...
  { name: 'Ms. Rosalyn Casalla', value: 'Rosalyn Casalla' },
  { name: 'Ma`am. Zarina Feleo', value: 'Zarina Feleo' },
  { name: 'Mrs. Jen-jen Valdez', value: 'Jen-jen Valdez' },
  { name: 'Mrs. Floser Nepomuceno', value: 'Floser Nepomuceno' },
  { name: 'Mrs. Michelle Cabututan', value: 'Michelle Cabututan' },
  { name: 'Mrs. Vergie Serato', value: 'Vergie Serato' },
]);
